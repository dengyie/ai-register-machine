...
def apply_env_config_overrides(cfg: dict | None = None) -> dict:
    ...
    for env_key, cfg_key, kind in (
        ...
        ("CPA_PREFER_PROTOCOL", "cpa_prefer_protocol", "bool"),
        ("CPA_MINT_TIMEOUT_SEC", "cpa_mint_timeout_sec", "int"),
        ...
        ("PROXY_ROTATE_ADVANCE_ON_START", "proxy_rotate_advance_on_start", "bool"),
