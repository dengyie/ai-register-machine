...
def test_tab_pool_chromium_start_lock_source() -> None:
    ...
    print("PASS  tab_pool chromium start lock")
...
def test_create_standalone_retries_and_lock() -> None:
    ...
    print("PASS  create_standalone retry+lock+orphan source")
...
def test_hard_recycle_cleans_orphans() -> None:
    ...
    print("PASS  hard recycle orphan cleanup source")
...
def test_start_browser_cleans_orphans_on_fail() -> None:
    ...
    print("PASS  start_browser orphan + chrome error page source")
...
def test_classify_email_stage_browser_boot() -> None:
    ...
    if "is_fatal_register_error" not in names:
        ...
        fn = next(n for n in tree.body if isinstance(n, ast.FunctionDef) and n.name == "classify_email_stage_failure")
    ...
    print("PASS  classify browser_boot")
